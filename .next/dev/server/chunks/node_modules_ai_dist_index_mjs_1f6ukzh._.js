...
var _a4;
var InvalidToolApprovalSignatureError = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AISDKError"] {
...
function getGlobalProvider() {
    var _a22;
    return (_a22 = globalThis.AI_SDK_DEFAULT_PROVIDER) != null ? _a22 : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$gateway$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["gateway"];
}
...
;
// src/version.ts
var VERSION = ("TURBOPACK compile-time truthy", 1) ? "6.0.206" : "TURBOPACK unreachable";
...
var download = async ({ url, maxBytes, abortSignal })=>{
    ...
    try {
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["fetchWithValidatedRedirects"])({
            url: urlText,
            headers,
            abortSignal
        });
...
async function recordSpan({ name: name22, tracer, attributes, fn, endWhenDone = true }) {
    return tracer.startActiveSpan(name22, {
...
function getRetryDelayInMs({ error, exponentialBackoffDelay }) {
    const headers = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["APICallError"].isInstance(error) ? error.responseHeaders : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["APICallError"].isInstance(error.cause) ? error.cause.responseHeaders : void 0;
...
async function _retryWithExponentialBackoff(f, { maxRetries, delayInMs, backoffFactor, abortSignal }, errors = []) {
    try {
        ...
        if (error instanceof Error && (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["APICallError"].isInstance(error) && error.isRetryable === true || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$gateway$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GatewayError"].isInstance(error) && error.isRetryable === true) && tryNumber <= maxRetries) {
...
function toBase64url(bytes) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["convertUint8ArrayToBase64"])(bytes).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/g, "");
}
function fromBase64url(str) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["convertBase64ToUint8Array"])(str);
}
...
async function validateApprovedToolApprovals({ approvedToolApprovals, tools, messages, experimental_context, toolApprovalSecret }) {
    ...
    for (const approval of approvedToolApprovals){
        ...
        if (tool2 != null && typeof tool2.execute === "function" && tool2.inputSchema != null) {
            const validation = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["safeValidateTypes"])({
                value: toolCall.input,
                schema: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["asSchema"])(tool2.inputSchema)
            });
...
var ToolLoopAgent = class {
   ...
   */ get tools() {
    ...
    async prepareCall(options) {
        ...
        const { instructions, allowSystemInMessages, messages, prompt, ...callArgs } = preparedCallArgs;
        return {
            ...callArgs,
...
originalMessages, onStepFinish, onFinish, generateId: generateId2 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generateId"] }) {
    let controller;
                    ...
                    modelMessages.push({
                        ...
                        content: message.parts.map((part)=>{
                            ...
                            if (isDataUIPart(part)) {
                                return (_a22 = options == null ? void 0 : options.convertDataPart) == null ? void 0 : _a22.call(options, part);
                            }
                ...
                const { embeddings: embeddings2, usage, warnings: warnings2, response, providerMetadata: providerMetadata2 } = await retry(()=>{
                    return recordSpan({
                        ...
                        fn: async (doEmbedSpan)=>{
                            ...
                            const usage2 = (_a23 = modelResponse.usage) != null ? _a23 : {
                                tokens: NaN
                            };
                            doEmbedSpan.setAttributes(await selectTelemetryAttributes({
                                telemetry,
                    ...
                    return retry(()=>{
                        return recordSpan({
                            ...
                            fn: async (doEmbedSpan)=>{
                                ...
                                const usage = (_a23 = modelResponse.usage) != null ? _a23 : {
                                    tokens: NaN
                                };
                                doEmbedSpan.setAttributes(await selectTelemetryAttributes({
                                    telemetry,
...
function simulateReadableStream({ chunks, initialDelayInMs = 0, chunkDelayInMs = 0, _internal }) {
    var _a22;
    const delay2 = (_a22 = _internal == null ? void 0 : _internal.delay) != null ? _a22 : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["delay"];
    let index = 0;
    return new ReadableStream({
        async pull (controller) {
...
var doWrap = ({ model, middleware: { transformParams, wrapGenerate, wrapStream, overrideProvider, overrideModelId, overrideSupportedUrls }, modelId, providerId })=>{
    ...
    return {
        specificationVersion: "v3",
        provider: (_a22 = providerId != null ? providerId : overrideProvider == null ? void 0 : overrideProvider({
            model
        })) != null ? _a22 : model.provider,
...
var doWrap3 = ({ model, middleware: { transformParams, wrapGenerate, overrideProvider, overrideModelId, overrideMaxImagesPerCall }, modelId, providerId })=>{
    ...
    const maxImagesPerCallRaw = (_a22 = overrideMaxImagesPerCall == null ? void 0 : overrideMaxImagesPerCall({
        model
    })) != null ? _a22 : model.maxImagesPerCall;
...
var NoSuchProviderError = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NoSuchModelError"] {
    ...
    static isInstance(error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$provider$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AISDKError"].hasMarker(error, marker21);
    }
};
_a21 = symbol21;
;
...
async function callCompletionApi({ api, prompt, credentials, headers, body, streamProtocol = "data", setCompletion, setLoading, setError, setAbortController, onFinish, onError, fetch: fetch2 = getOriginalFetch() }) {
    ...
    try {
        ...
        if (!response.ok) {
            throw new Error((_a22 = await response.text()) != null ? _a22 : "Failed to fetch the chat response.");
        }
        if (!response.body) {
...
//# sourceMappingURL=node_modules_ai_dist_index_mjs_1f6ukzh._.js.map